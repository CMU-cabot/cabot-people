...
class CrowdAttnRL(object):
    ...
    def __init__(self, sgan_model_path, model_dir, ckpt='41665.pt'):
        ...
        self.sgan = inference.SGANInference(sgan_model_path)
        ...
        load_path=os.path.join(model_dir, ckpt)
    ...
    def convert_observation(self, obs):
        ...
        # filter by distance and sort by distance using robot_pos and curr_pos
